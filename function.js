...
function sendEmail(){
    Email.send({
        ...
        Username: "gedamgaurav121@gmail.com",
        Password:"Gaurav@2001",
        To: "gedamgaurav121@gmail.com",
        from: "gedamgaurav121@gmail.com",
        Subject: document.querySelector('#subject').value,
        Body: document.getElementById('msg').value
    }).then(
        message => alert( Window.valNo + ",this no. of vaild mails has been sent successfully,press" + message + "to continue.")
